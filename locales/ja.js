const ja = {
  ...
  __COMMAND_SYS_PROFILE_LABEL: 'プロフィール',
  __COMMAND_SYS_PROFILE_TEXT: 'プロフィール',
  __COMMAND_SYS_PROFILE_ALIASES: ['/profile'],
  __COMMAND_SYS_PROFILE_REPLY: (name, isActivated) => `名前：${name}\n自動応答：${isActivated ? 'オン' : 'オフ'}`,
  __COMMAND_SYS_PROFILE_UPDATED_REPLY: (name) => `名前を「${name}」に更新しました。`,
