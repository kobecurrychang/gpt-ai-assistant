const zh = {
  ...
  __COMMAND_SYS_PROFILE_LABEL: '個人資料',
  __COMMAND_SYS_PROFILE_TEXT: '個人資料',
  __COMMAND_SYS_PROFILE_ALIASES: ['/profile'],
  __COMMAND_SYS_PROFILE_REPLY: (name, isActivated) => `名稱：${name}\n自動回覆：${isActivated ? '開啟' : '關閉'}`,
  __COMMAND_SYS_PROFILE_UPDATED_REPLY: (name) => `已更新名稱為「${name}」`,
