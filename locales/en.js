const en = {
  ...
  __COMMAND_SYS_PROFILE_LABEL: 'Profile',
  __COMMAND_SYS_PROFILE_TEXT: 'Profile',
  __COMMAND_SYS_PROFILE_ALIASES: ['/profile'],
  __COMMAND_SYS_PROFILE_REPLY: (name, isActivated) => `Name: ${name}\nAuto-reply: ${isActivated ? 'On' : 'Off'}`,
  __COMMAND_SYS_PROFILE_UPDATED_REPLY: (name) => `Name updated to "${name}".`,
